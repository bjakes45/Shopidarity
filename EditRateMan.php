...
if (isset($_POST['Submit'])){
    $delrate = "UPDATE `{$ratecode}` SET `Delete` = '1' WHERE `ManuId` = '$manuId' AND `Delete` = '0' LIMIT 1";
    ...
    <body>
        <div id="Holder">
            ...
            <div id="Content">
                ...
                <div id="ContentRight">
                    <form action ="EditRateMan.php?id=<?php echo $manuId;?>" method ="POST">
                    <h6>Your old Rating will be deleted.</h6>
                    <br /><input type='submit' name='Submit' value='Proceed'/></form>
                            <h6><br />Return to <a href="RateManu.php?id=<?php echo $manuId;?>">Manufacturer Rating</a>
                </div>
            </div>    
            <div id="Footer">
                <br /><br/>
