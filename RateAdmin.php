...
$getdeal = "SELECT * FROM `{$itemcode}` WHERE `ID` = '$dealId'";
$dinfo = mysqli_fetch_assoc(mysqli_query($dbconnect, $getdeal));
$point = $dinfo['PointPerson'];
$adminId = $dinfo['AdminId'];
$ratecode = ratead.$adminId;
...
if ($valid == 3){
    ...
    if (mysqli_query($dbconnect, $addrate)){
        ...
        $changerate = "UPDATE `login` SET `AdAvRate` = '$newrate' WHERE `id` = '$adminId'";
...
$getrate = "SELECT * FROM `login` WHERE `id` = '$adminId' LIMIT 1";
$oldrate = mysqli_fetch_assoc(mysqli_query($dbconnect, $getrate));
$adrate = $oldrate['AdAvRate']; 
?>
<!DOCTYPE html>
...
<html>
    ...
    <body>
        <div id="Holder">
            ...
            <div id="Content">
                <div id="PageHeading">
                    <h1><?php echo $point ?>'s Ratings</h1>
                    </div>
                <div id="ContentLeft">
                    <h2><?php echo $dbsuccess; echo $dbErr1; echo $dbErr2;?></h2>
                    <br /><h4>Rating: <b><?php echo $adrate; ?></b></h4>
<br />
                ...
                <div id="ContentRight">
                    ...
                    if ($rateyet == 0){
                        echo "<table>
                            <tr><td><h4><br/>Rate Admin</h4>
                        <br />
                        <form method ='POST' action='RateAdmin.php?item=".$itemId."&id=".$dealId."'>";
