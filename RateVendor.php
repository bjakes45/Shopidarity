...
if ($valid == 3){
    ...
    if (mysqli_query($dbconnect, $addrate)){
        ...
        $changerate = "UPDATE `vendor` SET `AvRate` = '$newrate' WHERE `ID` = '$vendId'";
        ...
        <div id="Holder">
            ...
            <div id="Content">
                ...
                <div id="ContentRight">
                    ...
                    if ($rateyet == 0){
                        echo "<table>
                            <tr><td><h4><br/>Rate Vendor</h4>
                            <br />
                        <form method ='POST' action='RateVendor.php?item=".$itemId."&id=".$dealId."'>
                            <select name ='NewRate'>
                                <option value ='0'";
                        ...
                        echo "<h4>Aleady Rated this Vendor.</h4>
                        ...
                        echo "<h2><br /><a href = 'FinDeal.php?item=".$itemId."&id=".$dealId."'>Finish the Deal!</a></h2>";
