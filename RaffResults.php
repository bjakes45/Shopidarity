...
$checkwin = "Select * FROM `{$dealcode}` WHERE `Raffwin` = '1'";
        ...
        <div id="Holder">
            ...
            <div id="Content">
                ...
                <div id="ContentRight"><br />
                    ...
                    <table>
                        <thead><td><h4>Participant</h4></td><td><h4>Win?</h4></td></thead>
                    <tr><td><h6><?php echo $point; ?></h6></td><td><h6>
                        <?php 
                    ...
                    <br />
                    <h4>Back to <a href="CompleteDeal.php?item=<?php echo $itemId; ?>&id=<?php echo $dealId;?>">Deal Completion</a></h4>
</div>
            </div>
            <div id="Footer"><br /><br/>
